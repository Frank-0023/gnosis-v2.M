...
interface JungleAdventureMultiplicationProps {
  onBack: () => void;
}

export default function JungleAdventureMultiplication({
  onBack,
}: JungleAdventureMultiplicationProps) {
  ...
  if (gameComplete) {
    return (
      <div className="min-h-screen bg-black relative overflow-hidden flex items-center justify-center">
        <div className="absolute inset-0 bg-gradient-to-br from-purple-900/60 via-indigo-900/50 to-blue-900/60" />
        <div className="absolute inset-0 bg-[url('/space-with-dragons-and-stars.jpg')] bg-cover bg-center opacity-30" />
  ...
  return (
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-12">
        <div className="bg-gradient-to-br from-purple-800/40 to-indigo-900/40 backdrop-blur-xl rounded-3xl border-4 border-purple-600/50 shadow-2xl shadow-purple-500/20 p-8">
          <div className="bg-gradient-to-br from-purple-700 to-indigo-900 rounded-2xl p-6 mb-8 border-4 border-purple-600 shadow-lg">
            <h2 className="text-3xl font-bold text-center text-white mb-2">
              Desafio de Multiplicación
            </h2>
          ...
          <div className="bg-purple-800/60 rounded-2xl p-8 mb-8 border-2 border-purple-600/50">
            <p className="text-2xl text-white text-center mb-6 leading-relaxed">
              ...
              grupos con <span className="text-pink-400 font-bold">{num2}</span>{" "}
              dragones cada uno, cuantos dragones tienes en total?
            </p>
