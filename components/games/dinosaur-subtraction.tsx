  ...
  return (
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-12">
        <div className="bg-gradient-to-br from-orange-500/20 to-amber-500/20 backdrop-blur-xl rounded-3xl border-2 border-orange-500/50 shadow-2xl shadow-orange-500/20 p-8">
          ...
          <div className="flex items-center justify-center gap-8 mb-12">
            ...
            <div className="text-6xl font-bold text-orange-400">-</div>
